...
CT.i18n = (function () {
  ...
  const STR = {
    fr: {
      ...
      'btn.daily': '📅 DÉFI DU JOUR', 'btn.weekly': '📆 DÉFI DE LA SEMAINE', 'btn.chrono': '⏱️ CHRONO — 2 MIN', 'btn.versus': '👥 2 JOUEURS — DUEL',
      'home.record': '🏆 Record :',
      ...
      'board.week': '📅 TOP DE LA SEMAINE', 'board.venueHere': '🏆 Meilleurs à {venue}', 'lb.empty': 'Sois le premier du classement !',
      ...
      'lab.researching': 'recherche…', 'lab.ready': '✓ Prêt', 'lab.claim': 'RÉCUPÉRER', 'lab.finish': 'Terminer',
      'lab.next': 'Prochain : ', 'lab.max': ' (max)', 'lab.busy': 'Labo occupé', 'lab.research': 'Rechercher',
      'lab.queue': '＋ File', 'lab.queued': 'En file :', 'lab.cancelQueue': 'Annuler la file (remboursé)',
      'lab.unlocked': 'débloqué !',
      'lab.cat.eco': '💰 Économie & score', 'lab.cat.power': '🎁 Power-ups', 'lab.cat.survie': '🛡️ Survie', 'lab.cat.meta': '🔬 Labo',
      'lab.queueEta': 'file terminée dans', 'lab.need': 'manque',
      'btn.back': 'RETOUR',
      ...
      'operator.title': '🛠️ MODE OPÉRATEUR', 'operator.intro': 'Configuration de cette borne. Le lien alimente le QR de fin de partie et la carte de score partagée.',
      'operator.venue': '📍 Nom du lieu', 'operator.venuePh': 'Bar des Sports', 'operator.url': '🔗 Lien CTA (QR)',
      'operator.save': 'ENREGISTRER', 'operator.reset': 'Réinitialiser la borne', 'operator.saved': '✓ Borne enregistrée',
      'operator.reward': '🎁 Récompense au bar (option)', 'operator.rewardPh': 'Ex : Recharge offerte', 'operator.rewardScore': '🎯 Score à atteindre',
      'reward.unlocked': 'RÉCOMPENSE DÉBLOQUÉE !', 'reward.showStaff': '📲 Montre cet écran au staff du bar',
      ...
      'options.diff': '⚔️ Difficulté', 'options.diff.desc': 'Vitesse & obstacles (partie normale solo).',
      'options.controls': '🎮 Contrôles tactiles', 'options.controls.desc': 'Sur mobile : comment diriger le serpent.',
      'ctrl.dpad': 'D-pad', 'ctrl.swipe': 'Glisser', 'ctrl.zones': 'Zones', 'ctrl.joystick': 'Joystick',
      'options.sens': '🎚️ Sensibilité tactile', 'options.sens.desc': 'Réactivité du glisser / joystick.',
      'sens.low': 'Faible', 'sens.med': 'Moyenne', 'sens.high': 'Élevée',
      'options.joysize': '🕹️ Taille du joystick', 'options.joysize.desc': 'Pour le schéma « Joystick ».',
      'size.small': 'Petit', 'size.med': 'Moyen', 'size.large': 'Grand',
      'diff.easy': 'Facile', 'diff.normal': 'Normal', 'diff.hard': 'Difficile',
      'pause.title': 'PAUSE', 'btn.resume': 'REPRENDRE', 'btn.restart': 'RECOMMENCER', 'btn.menu': 'MENU',
      'over.name': 'Pseudo', 'over.name.ph': 'Ton pseudo',
      'tab.daily': '☀️ Jour', 'tab.weekChallenge': '📆 Défi sem.', 'tab.weekly': '📅 Semaine', 'tab.global': '🌍 Global', 'tab.chrono': '⏱ Chrono',
      ...
      'btn.retry': 'REJOUER', 'btn.defi': '📲 Défier un ami', 'btn.share': '📸 Partager mon score',
      'share.scoreLabel': 'SCORE', 'share.tagline': 'Tu peux battre mon score ?',
      'share.findStation': '📲 Trouve une borne Cryptotem',
      'share.text': "J'ai marqué {score} sur Snake Cryptotem ! Tu peux faire mieux ? 🔋",
      ...
      'intro.daily': '📅 DÉFI DU JOUR', 'intro.daily.ghost': '  ·  👻 à battre : {score}', 'intro.week': '📆 DÉFI DE LA SEMAINE — même map pour tous',
      ...
      'tuto.move.swipe': '⬆️ Dirige : flèches/WASD, ou glisse le doigt sur le plateau',
      'tuto.move.zones': '⬆️ Dirige : flèches/WASD, ou tape à gauche/droite pour tourner',
      'tuto.move.joystick': '⬆️ Dirige : flèches/WASD, ou pose le doigt (joystick) et incline',
      'tuto.move.dpad': '⬆️ Dirige : flèches/WASD, ou le D-pad en bas de l\'écran',
    ...
    en: {
      ...
      'btn.daily': '📅 DAILY CHALLENGE', 'btn.weekly': '📆 WEEKLY CHALLENGE', 'btn.chrono': '⏱️ TIME ATTACK — 2 MIN', 'btn.versus': '👥 2 PLAYERS — DUEL',
      'home.record': '🏆 Best:',
      ...
      'board.week': '📅 TOP OF THE WEEK', 'board.venueHere': '🏆 Best at {venue}', 'lb.empty': 'Be the first on the board!',
      ...
      'lab.researching': 'researching…', 'lab.ready': '✓ Ready', 'lab.claim': 'CLAIM', 'lab.finish': 'Finish now',
      'lab.next': 'Next: ', 'lab.max': ' (max)', 'lab.busy': 'Lab busy', 'lab.research': 'Research',
      'lab.queue': '＋ Queue', 'lab.queued': 'Queued:', 'lab.cancelQueue': 'Cancel queue (refunded)',
      'lab.unlocked': 'unlocked!',
      'lab.cat.eco': '💰 Economy & score', 'lab.cat.power': '🎁 Power-ups', 'lab.cat.survie': '🛡️ Survival', 'lab.cat.meta': '🔬 Lab',
      'lab.queueEta': 'queue done in', 'lab.need': 'need',
      'btn.back': 'BACK',
      ...
      'operator.title': '🛠️ OPERATOR MODE', 'operator.intro': 'Configure this terminal. The link powers the game-over QR and the shared score card.',
      'operator.venue': '📍 Venue name', 'operator.venuePh': 'Sports Bar', 'operator.url': '🔗 CTA link (QR)',
      'operator.save': 'SAVE', 'operator.reset': 'Reset terminal', 'operator.saved': '✓ Terminal saved',
      'operator.reward': '🎁 Bar reward (optional)', 'operator.rewardPh': 'e.g. Free charge', 'operator.rewardScore': '🎯 Score to reach',
      'reward.unlocked': 'REWARD UNLOCKED!', 'reward.showStaff': '📲 Show this screen to the bar staff',
      ...
      'options.diff': '⚔️ Difficulty', 'options.diff.desc': 'Speed & obstacles (normal solo game).',
      'options.controls': '🎮 Touch controls', 'options.controls.desc': 'On mobile: how to steer the snake.',
      'ctrl.dpad': 'D-pad', 'ctrl.swipe': 'Swipe', 'ctrl.zones': 'Zones', 'ctrl.joystick': 'Joystick',
      'options.sens': '🎚️ Touch sensitivity', 'options.sens.desc': 'Swipe / joystick responsiveness.',
      'sens.low': 'Low', 'sens.med': 'Medium', 'sens.high': 'High',
      'options.joysize': '🕹️ Joystick size', 'options.joysize.desc': 'For the “Joystick” scheme.',
      'size.small': 'Small', 'size.med': 'Medium', 'size.large': 'Large',
      ...
      'tab.daily': '☀️ Day', 'tab.weekChallenge': '📆 Weekly', 'tab.weekly': '📅 Week', 'tab.global': '🌍 Global', 'tab.chrono': '⏱ Time',
      ...
      'btn.retry': 'PLAY AGAIN', 'btn.defi': '📲 Challenge a friend', 'btn.share': '📸 Share my score',
      'share.scoreLabel': 'SCORE', 'share.tagline': 'Can you beat my score?',
      'share.findStation': '📲 Find a Cryptotem station',
      'share.text': 'I scored {score} on Snake Cryptotem! Can you do better? 🔋',
      ...
      'intro.daily': '📅 DAILY CHALLENGE', 'intro.daily.ghost': '  ·  👻 to beat: {score}', 'intro.week': '📆 WEEKLY CHALLENGE — same map for everyone',
      ...
      'tuto.move.swipe': '⬆️ Steer: arrows/WASD, or slide your finger on the board',
      'tuto.move.zones': '⬆️ Steer: arrows/WASD, or tap left/right to turn',
      'tuto.move.joystick': '⬆️ Steer: arrows/WASD, or hold to get the joystick and tilt',
      'tuto.move.dpad': '⬆️ Steer: arrows/WASD, or the on-screen D-pad',
    ...
    es: {
      ...
      'btn.daily': '📅 RETO DIARIO', 'btn.weekly': '📆 RETO SEMANAL', 'btn.chrono': '⏱️ CONTRARRELOJ — 2 MIN', 'btn.versus': '👥 2 JUGADORES — DUELO',
      'home.record': '🏆 Récord:',
      ...
      'board.week': '📅 TOP DE LA SEMANA', 'board.venueHere': '🏆 Mejores en {venue}', 'lb.empty': '¡Sé el primero del ranking!',
      ...
      'lab.researching': 'investigando…', 'lab.ready': '✓ Listo', 'lab.claim': 'RECOGER', 'lab.finish': 'Terminar ya',
      'lab.next': 'Siguiente: ', 'lab.max': ' (máx)', 'lab.busy': 'Lab ocupado', 'lab.research': 'Investigar',
      'lab.queue': '＋ Cola', 'lab.queued': 'En cola:', 'lab.cancelQueue': 'Cancelar cola (reembolsado)',
      'lab.unlocked': '¡desbloqueado!',
      'lab.cat.eco': '💰 Economía y puntos', 'lab.cat.power': '🎁 Mejoras', 'lab.cat.survie': '🛡️ Supervivencia', 'lab.cat.meta': '🔬 Lab',
      'lab.queueEta': 'cola lista en', 'lab.need': 'faltan',
      'btn.back': 'VOLVER',
      ...
      'operator.title': '🛠️ MODO OPERADOR', 'operator.intro': 'Configura esta terminal. El enlace alimenta el QR de fin de partida y la tarjeta de puntuación compartida.',
      'operator.venue': '📍 Nombre del local', 'operator.venuePh': 'Bar Deportivo', 'operator.url': '🔗 Enlace CTA (QR)',
      'operator.save': 'GUARDAR', 'operator.reset': 'Reiniciar terminal', 'operator.saved': '✓ Terminal guardada',
      'operator.reward': '🎁 Recompensa en el bar (opcional)', 'operator.rewardPh': 'Ej: Recarga gratis', 'operator.rewardScore': '🎯 Puntuación a alcanzar',
      'reward.unlocked': '¡RECOMPENSA DESBLOQUEADA!', 'reward.showStaff': '📲 Muestra esta pantalla al personal del bar',
      ...
      'options.diff': '⚔️ Dificultad', 'options.diff.desc': 'Velocidad y obstáculos (partida normal individual).',
      'options.controls': '🎮 Controles táctiles', 'options.controls.desc': 'En móvil: cómo dirigir la serpiente.',
      'ctrl.dpad': 'D-pad', 'ctrl.swipe': 'Deslizar', 'ctrl.zones': 'Zonas', 'ctrl.joystick': 'Joystick',
      'options.sens': '🎚️ Sensibilidad táctil', 'options.sens.desc': 'Respuesta del deslizar / joystick.',
      'sens.low': 'Baja', 'sens.med': 'Media', 'sens.high': 'Alta',
      'options.joysize': '🕹️ Tamaño del joystick', 'options.joysize.desc': 'Para el esquema «Joystick».',
      'size.small': 'Pequeño', 'size.med': 'Mediano', 'size.large': 'Grande',
      'diff.easy': 'Fácil', 'diff.normal': 'Normal', 'diff.hard': 'Difícil',
      'pause.title': 'PAUSA', 'btn.resume': 'CONTINUAR', 'btn.restart': 'REINICIAR', 'btn.menu': 'MENÚ',
      'over.name': 'Alias', 'over.name.ph': 'Tu alias',
      'tab.daily': '☀️ Día', 'tab.weekChallenge': '📆 Reto sem.', 'tab.weekly': '📅 Semana', 'tab.global': '🌍 Global', 'tab.chrono': '⏱ Tiempo',
      ...
      'btn.retry': 'JUGAR DE NUEVO', 'btn.defi': '📲 Retar a un amigo', 'btn.share': '📸 Compartir mi puntuación',
      'share.scoreLabel': 'PUNTUACIÓN', 'share.tagline': '¿Puedes superar mi puntuación?',
      'share.findStation': '📲 Encuentra una estación Cryptotem',
      'share.text': '¡Marqué {score} en Snake Cryptotem! ¿Puedes hacerlo mejor? 🔋',
      ...
      'intro.daily': '📅 RETO DIARIO', 'intro.daily.ghost': '  ·  👻 a batir: {score}', 'intro.week': '📆 RETO SEMANAL — misma mapa para todos',
      ...
      'research.done': '🔬 ¡INVESTIGACIÓN LISTA!',
      'tuto.move': '⬆️ Dirige hacia la batería: flechas, WASD o deslizar', 'tuto.border': '🌀 Lánzate a un borde: ¡sales por el otro lado!',
      'tuto.move.swipe': '⬆️ Dirige: flechas/WASD, o desliza el dedo por el tablero',
      'tuto.move.zones': '⬆️ Dirige: flechas/WASD, o toca izquierda/derecha para girar',
      'tuto.move.joystick': '⬆️ Dirige: flechas/WASD, o mantén para el joystick e inclina',
      'tuto.move.dpad': '⬆️ Dirige: flechas/WASD, o el D-pad en pantalla',
  ...
  const SKIN = {
    en: {
      ...
      head: { classic: 'T Logo', drole: 'Sly', agressif: 'Aggressive', ete: 'Summer', sperm: 'Spermatozoon', ver: 'Earthworm' },
      trail: { none: 'None', etincelles: 'Sparks', bulles: 'Bubbles', flamme: 'Flames', etoiles: 'Stars' },
      enemyhead: { classic: 'Fierce', drole: 'Evil Clown', agressif: 'Enraged', ete: 'Stalker', sperm: 'Spermatozoon', ver: 'Earthworm' },
    },
    es: {
      ...
      head: { classic: 'Logo T', drole: 'Malicioso', agressif: 'Agresivo', ete: 'Verano', sperm: 'Espermatozoide', ver: 'Lombriz' },
      trail: { none: 'Ninguna', etincelles: 'Chispas', bulles: 'Burbujas', flamme: 'Llamas', etoiles: 'Estrellas' },
      enemyhead: { classic: 'Feroz', drole: 'Payaso macabro', agressif: 'Enfurecido', ete: 'Acechador', sperm: 'Espermatozoide', ver: 'Lombriz' },
    },
  };
  ...
  const LAB_DESC = {
    en: {
      ...
      antivirus: (l) => (l * 5) + '% chance to neutralize a picked-up malus',
      phenix: (l) => l + ' revive' + (l > 1 ? 's' : '') + ' per game (grace shield on death)',
      mission: (l) => '+' + (l * 20) + '% ⚡ on completed missions',
      primeNiveau: (l) => '+' + (l * 25) + ' ⚡ to the Lab per level cleared',
      primeSurvie: (l) => '+' + (l * 5) + ' ⚡ to the Lab per 30 s survived',
